          ...
          <Row className="align-items-center g-5">
            <Col lg={6} className="animate-fade-up">
              ...
              <div className="d-flex flex-wrap gap-3 mb-5">
                <Button className="btn-pf-primary btn btn-lg" onClick={() => navigate('/scan')}>
                  Masuk & Scan Tiket
                </Button>
                <Button className="btn-pf-outline btn btn-lg" onClick={() => navigate('/parking')}>
                  Cari Parkir
                </Button>
              </div>
                ...
                <div className="d-flex flex-wrap gap-3">
                  <a href="#" className="download-btn" onClick={e => e.preventDefault()}>
                    <span className="download-btn-icon">
                      <img src={`${CDN}/foto/android.png`} alt="Android" style={{ width:24, height:24, objectFit:'contain' }} />
                    </span>
                  ...
                  <a href="#" className="download-btn" onClick={e => e.preventDefault()}>
                    <span className="download-btn-icon">
                      <img src={`${CDN}/foto/ios.png`} alt="iOS" style={{ width:24, height:24, objectFit:'contain' }} />
                    </span>
                    <span className="download-btn-text">
                      <small>Download via</small>
                      <strong>iOS</strong>
                ...
                <Card.Body>
                  <Row className="align-items-center">
                    ...
                    <Col>
                      ...
                      <ProgressBar now={p.occupancy} variant={p.variant} style={{ height:6 }} />
                    </Col>
                    ...
                    <Col xs={12} className="mt-3 d-flex justify-content-between align-items-center">
                      ...
                      <Button
                        ...
                        onClick={() => navigate('/scan', { state: { redirect: '/booking', parking: p } })}
                      >
                        Booking Sekarang
                      </Button>
                    </Col>
            ...
            <Card.Body className="p-5">
              <Row className="align-items-center g-4">
                <Col lg={7}>
                  ...
                  <div className="d-flex flex-wrap gap-3">
                    <a href="#" className="download-btn download-btn-lg" onClick={e => e.preventDefault()}>
                      <span className="download-btn-icon">
                        <img src={`${CDN}/foto/android.png`} alt="Android" style={{ width:28, height:28, objectFit:'contain' }} />
                      </span>
                      <span className="download-btn-text">
                        <small>Download via</small>
                        <strong>Android</strong>
                    ...
                    <a href="#" className="download-btn download-btn-lg" onClick={e => e.preventDefault()}>
                      <span className="download-btn-icon">
                        <img src={`${CDN}/foto/ios.png`} alt="iOS" style={{ width:28, height:28, objectFit:'contain' }} />
                      </span>
                      <span className="download-btn-text">
                        <small>Download via</small>
                        <strong>iOS</strong>
        ...
        <Container>
          <Row className="mb-4 g-4">
            ...
            <Col md={3}>
              ...
              {[['Scan Tiket','/scan'],['Cari Parkir','/parking'],['Booking','/booking']].map(([l,p]) => (
                <div key={l}>
                  <Button variant="link" className="text-muted-pf p-0 text-decoration-none d-block" style={{ fontSize:14 }} onClick={() => navigate(p)}>{l}</Button>
                </div>
              ))}
            </Col>
            <Col md={4}>
